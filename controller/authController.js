...
import { accessToken, refreshToken, refreshTokenValidator } from "../utils/token.js";
...
const login = async (req, res) => {
  ...
  res.status(StatusCodes.CREATED).json("login successfull");
};
...
export { register, login, getAccessToken,logout };
